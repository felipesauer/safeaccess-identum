...
| ----------------------------- | ------- | :-------: |
| `safeaccess/identum` (PHP)    | 0.x     |    ✅     |
| `@safeaccess/identum` (JS/TS) | 0.x     |    ✅     |
...
1. Go to the [**Security** tab → **Report a vulnerability**](https://github.com/felipesauer/safeaccess-identum/security/advisories/new).
...
**Thank you** for helping keep `safeaccess-identum` secure!
