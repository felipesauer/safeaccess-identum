...
```bash
git clone https://github.com/felipesauer/safeaccess-identum.git
cd safeaccess-identum
```
...
```
feat(php): implement CPF validation
fix(js): handle null input on CNPJ validator
docs: update quickstart commands
ci: add matrix build for PHP 8.4
